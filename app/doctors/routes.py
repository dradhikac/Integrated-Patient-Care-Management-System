...
def ensure_doctors_seeded():
    try:
        ...
        sample_doctors = [
            {'code': 'DOC-001', 'name': 'Dr. Rajesh Sharma', 'specialization': 'General Medicine & Cardiology', 'education': 'MBBS, MD (General Medicine)', 'experience': '15+ Years', 'department': 'Cardiology & Heart Institute', 'bio': 'Senior consultant physician and cardiologist with 15+ years of clinical excellence in patient care.', 'fee': 600.0, 'image_url': '/static/images/doctors/dr_rajesh_sharma.jpg', 'email': 'doctor@ipcms.com'},
