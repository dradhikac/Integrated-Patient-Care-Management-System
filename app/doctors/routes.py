...
def ensure_doctors_seeded():
    try:
        ...
        sample_doctors = [
            {'code': 'DOC-001', 'name': 'Dr. Rajesh Sharma', 'specialization': 'General Physician', 'education': 'MBBS, MD (General Medicine)', 'experience': '15+ Years', 'department': 'General Medicine', 'bio': 'Senior consultant physician with 15+ years of clinical excellence in comprehensive primary and internal medicine.', 'fee': 600.0, 'image_url': '/static/images/doctors/dr_rajesh_sharma.jpg', 'email': 'doctor@ipcms.com'},
